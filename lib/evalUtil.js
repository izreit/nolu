// Import all core modules to expose to the code executed by evaluate().
...
// The variables to be refered from the code executed by evaluate()
var $_ = null;
var $F = null;
...
module.exports = {
  ...
  // eval() must be called directly to make the variables in this file accessible from the code passed to eval().
  evaluate: function () {
