...
function printHelp() {
  console.log([
    ...
    "  -f                  assume your code is a function and call it with $_ and $F",
...
module.exports = function nolu(opts, inStream, outFd, callback) {
  ...
  var executeAsFunc = (code) => _eval(code)(evalUtil.$_(), evalUtil.$F());
  var executeAndPrint = (code, last) => {
    _eval(code);
    (last ? printLast : print)(evalUtil.$_(), evalUtil.$F());
  };
